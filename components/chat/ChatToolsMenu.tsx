...
import { WrenchScrewdriverIcon, CogIcon, BrainIcon, BookOpenIcon } from '../common/Icons.tsx';
    ...
    return (
        <>
            ...
            {isOpen && createPortal(
                ...
                >
                    {/* Story Mode */}
                    <div className="flex items-center justify-between px-3 py-2 rounded-md text-xs font-medium transition-colors w-full group text-gray-400 hover:bg-white/5 hover:text-gray-200">
                        <button 
                            onClick={(e) => { e.stopPropagation(); openStoryManagerModal(); setIsOpen(false); }} 
