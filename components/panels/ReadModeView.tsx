...
const CodeBlock: React.FC<React.PropsWithChildren<{ inline?: boolean; className?: string }>> = memo(({
  ...
  return (
    <div className="relative group/codeblock my-2 rounded-md border border-[var(--aurora-border)] bg-[var(--aurora-code-bg)]">
      <div className="sticky top-0 z-10 flex justify-between items-center px-4 py-1.5 bg-black/40 rounded-t-md border-b border-white/5">
...
const ReadModeView: React.FC<ReadModeViewProps> = memo(({ 
  ...
  return (
    <div
      className="fixed inset-0 bg-black/70 backdrop-blur-md z-40 flex flex-col p-4 sm:p-8 md:p-12 pt-24 transition-colors duration-300"
      onClick={onClose} 
      role="dialog"
      aria-modal="true"
    >
