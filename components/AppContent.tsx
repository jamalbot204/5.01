...
const AppContent: React.FC = memo(() => {
  ...
  const readModeContent = useMemo(() => {
      if (isStreaming && streamingMessageId && readModeMessageId === streamingMessageId) {
      ...
      return cleanContent;
  }, [readModeMessageId, currentChatSession, isStreaming, streamingMessageId, streamingText]);
